...
public class SoundM1 extends PApplet {
  ...
  public void setup() {
    ...
    // getLineIn(sound type, buffer size, sample rate, bit depth)
  ...
  public void drawCircleWidths() {
    ...
    float circleDiameter = average * 5000;
  ...
  public void drawCircleY() {
    ...
    // lerp(0, 10, 0.1f) = 1
    lerpedCircleY = lerp(lerpedCircleY, circleY, 0.05f);
