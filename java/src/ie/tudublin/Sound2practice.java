...
public class Sound2practice extends PApplet{
    ...
    float frameToSecond = sampleRate / (float) framSize;
    ...
    public void setup()
    {
        ...
        as = minim.loadSample("scale.wav", framSize);

        fft = new FFT(framSize, sampleRate);
    ...
    public void draw()
    {
        ...
        textSize(22);
        text("Zero crossing frequency: " + freq, 100, 50);
